        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Un projet étudiant authentique qui rassemble toute la richesse de l&apos;EPF : son histoire, ses campus, sa
              culture scientifique et l&apos;esprit unique qui anime notre communauté.
            </p>
            <div className="flex gap-4 justify-center">
  <Image
    src="/verso.png"
    alt="Cartes EPF - Exemples de cartes du jeu"
    width={300} // réduit la largeur
    height={240}
  ...
  />
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  ...
                  vous êtes un vrai connaisseur de l&apos;EPF !
                </p>
              </div>
        ...
        <div className="text-center mt-8">
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            <strong>261 cartes uniques</strong> conçues avec amour par l&apos;association BDJ pour célébrer notre école.
            Chaque carte raconte une partie de l&apos;histoire EPF, de ses moments les plus glorieux à ses anecdotes les plus
            croustillantes !
          </p>
        </div>
      </div>
